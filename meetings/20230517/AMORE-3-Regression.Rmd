...
We can evaluate the output of our nonlinear model by calling the variable $m$.
...
##Extracting Coefficients
```{r}
coef(mnonlinear)[1] #Intercept
coef(mnonlinear)[2] #Slope

coef(mnonlinear) #Intercept and slope
```

We cam compute the 95% t CI of the slope of this nonlinear regression.
```{r}
