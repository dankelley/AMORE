...
1. History of GUIs, difficulty in programming them, and how shiny solved the problem by using the javascript language to link R to webpages.
...
In the next (5th) meeting, DEK plans to discuss the AI (artificial intelligence)
...
* After the meeting, DEK made a 35-minute video that went over the 4 shiny apps.
  ...
  than other recording methods.)  The video is at https:
  //www.dropbox.com/s/6mzxae4jn68vy47/amore_meeting_4_followup.mp4?dl=0
