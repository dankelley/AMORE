...
quenched" case, in which $P$ remains constant once it reaches its peak value at
a certain irradiance.

An example of such a curve is Figure 4b of Platt et al. (1980), shown below.

![Figure 4b from Platt et al. (1980)](platt1980fig4b.png){width="80%"}
